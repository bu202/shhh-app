...
| 심각도 | 해결 | 미해결 |
|---|---|---|
| Critical (P0) | 12 / 12 | 0 (2026-08-14 에 클라이언트 3건 추가 해결) |
| High (P1) | 8 / 8 | 0 (2026-08-14 에 레이트리밋·세션 정리·스키마 readiness·상한 경합·Origin 해결) |
| Medium (P2) | 5 / 5 | 0 |
| 법률 | — | 개인정보 법률 검토 (**AI 가 판정하지 않는다**) |

**현재 판정(2026-08-14): 개발자 본인 계정 테스트 가능 · 외부 비공개 계정 테스트는 실기기 확인 후 ·
