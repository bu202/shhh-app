...
> | 4단계 코드·DB 구현 | **로컬 구현 완료 2026-08-18 · 원격 미반영 · 배포 0건.** 전역 user-data drain 은 결정 A′ 로 구현됐다 — **HTTP 요청과 정리 크론 둘 다**(크론은 2026-08-18 에 편입했다) |
>
...
> | ⑨ | **T8 이 아직 「200」** | ⑦ 을 테스트로 고정한 것이다. 거부로 바꾸는 길은 코드가 아니라 **옛 배포를 없애거나 닿지 못하게 하는 것**이다 |
>
