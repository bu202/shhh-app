...
> 처럼 개별 날짜는 그때의 사실로 남긴다 — **현재 운영 상태(배포·원격)는 2026-08-24 실측**이다.
>
> <!-- 현재상태:시작 -->
>
> | 단계 | 상태 |
> |---|---|
> | 1단계 보안 기준선 | **완료 2026-08-19** (**당시** 배포 `f72f5225` — 2026-08-22 에 지운 세대다 · `RL_KEY` 등록 · 원격 `0004` 적용). 마지막까지 남아 있던 옛 엣지 캐시 내부 파일 7개도 **08-19 18:15 KST 실측에서 전부 SPA 폴백**(9,994B · `dist/index.html` 과 sha256 동일 · `cf-cache-status` 없음) |
