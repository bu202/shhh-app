...
//    나쁘다 — 아무도 못 알아채고 방침만 거짓말이 된다. 세지 않고 `null` 을 준다.
// ⛔ **그 뒤가 2026-08-22 에 바뀌었다**(위협 52). 예전에는 못 세면 **통과**시키고 readiness 만
//    시끄러웠다 — 계정 경로가 열려 있는 한 「말만 하는 경보」는 방어가 아니다. 이제 부르는 쪽
//    (`countVerdict`)이 `broken` 으로 읽어 **503** 이다.
